...
import type { Province, PlateParseResult } from '../types'
...
interface SearchResult extends Province {
  matchType: string
  score: number
}
 ...
 * 根据输入模糊搜索省份
 */
export function searchProvinces(keyword: string): SearchResult[] {
...
export const CITY_CODE_MAP: Record<string, string> = {
  // 北京
  '京A': '北京市', '京B': '北京市', '京C': '北京市', '京D': '北京市', '京E': '北京市',
 ...
 * 验证车牌号格式并提取省份代码和城市信息
 */
export function parsePlateNumber(plateNumber: string): PlateParseResult {
